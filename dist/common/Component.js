...
;
require("./components/ChatManager");
require("./components/FirstPersonController");
require("./components/MachineController");
require("./components/MachineTrigger");
require("./components/MouseControlRotation");
require("./components/SortController");
require("./components/SortTrigger");
require("./components/StepTrigger");
