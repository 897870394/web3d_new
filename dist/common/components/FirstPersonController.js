 ...
 * 控制玩家第一人称行走
 */
let FirstPersonController = (_dec = Component.clientOnly, _dec2 = Component.serializedName('FirstPersonController'), _dec(_class = _dec2(_class = class FirstPersonController extends Component {
