 ...
 * 挂在玩家对象身上，同步位置信息
 */
let Synchronizer = (_dec = Component.serializedName('Synchronizer'), _dec(_class = class Synchronizer extends Component {
    ...
    update(deltaTime) {
        ...
        if (ENV_CLIENT && this.isLocalPlayer && ++this.cycle >= this.props.interval && Client.current != null) {
            // 本机，定期向服务器上报自身状态
