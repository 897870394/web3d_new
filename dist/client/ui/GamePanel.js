...
let GamePanel = class GamePanel extends React.Component {
    ...
    render() {
        return React.createElement(
            ...
            React.createElement(
                'div',
                { style: { position: 'absolute', background: 'rgba(0,0,0,0.5)',
                        width: '100%', height: '100%', color: '#fff', textAlign: 'center',
                        display: 'flex', alignItems: 'center' },
                    ref: mount => {
                        this.instruction = mount;
                    } },
                React.createElement(
                    'span',
                    ...
                    '\u9F20\u6807\u79FB\u52A8\u63A7\u5236\u89C6\u89D2\uFF0CWASD\u79FB\u52A8\uFF0C\u6309\u56DE\u8F66\u5BF9\u8BDD'
                )
            ),
            React.createElement('div', { style: { display: 'flex', flexDirection: 'column-reverse', width: 200, height: 100,
                    position: 'absolute', left: 10, bottom: 40 }, id: 'chatPanel' }),
            React.createElement('input', { type: 'text', id: 'chatInput', style: { position: 'absolute', left: 10, bottom: 10,
